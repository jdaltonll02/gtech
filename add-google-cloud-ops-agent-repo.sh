...
handle_rpm() {
  ...
  add_repo() {
    ...
    local GPG_KEYS=""
    # Starting with EL 10, there is a new package signing key.
    if [[ "${MAJOR_VERSION}" == '10' ]]; then
      GPG_KEYS="https://${REPO_HOST}/yum/doc/rpm-package-key-v10.gpg"
    else
      GPG_KEYS="https://${REPO_HOST}/yum/doc/yum-key.gpg
